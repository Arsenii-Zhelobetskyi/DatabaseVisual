...
<template>
    <svg v-if="name === 'reset'" width="18" height="18" viewBox="0 0 32 32">
        <path
            d="M18 28A12 12 0 1 0 6 16v6.2l-3.6-3.6L1 20l6 6l6-6l-1.4-1.4L8 22.2V16a10 10 0 1 1 10 10Z"
        />
    </svg>

    <svg v-if="name === 'update'" width="18" height="18" viewBox="0 0 24 24">
        <path
    ...
    <svg v-if="name === 'sun'" width="18" height="18" viewBox="0 0 24 24">
        <path
    ...
    <svg v-if="name === 'moon'" width="18" height="18" viewBox="0 0 24 24">
        <path
    ...
    <svg v-if="name === 'log'" width="18" height="18" viewBox="0 0 24 24">
        <path
